...
var Packages = []Pkg{
	{
		...
		Topics: []Topic{{
			...
			Blurb: "Audio, camera, clipboard, compass heading, location, maps and the app lifecycle.",
			Files: []string{"audio.go", "camera.go", "clipboard.go", "heading.go", "location.go", "mapview.go", "lifecycle.go"},
		}},
	},
	{
		Dir:   "hooks",
