...
type rowsSpec[T any] struct {
	...
	// OnToggle.
	//
	// comps.CollapseBand is what an override wires it to. It is the
	...
	// wrapper from the argument in comps.disclosure.
	Collapse Collapse
...
func appendRows[T any](
	...
	for _, run := range runs {
		...
		if spec.Header != nil {
			...
			//
			// comps.CollapseBand is how the override builds one that
