...
// lists with the menu core.SelectMenuSections says each decomposes into. It
// rides along here because the harness is a single executable. The table
// itself is internal/menufixture, shared with android/verify and wasm/verify
// — three transliterations of one rule, held to one statement of it.
package main
