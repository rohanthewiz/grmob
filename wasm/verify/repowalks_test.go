...
// files it touches. That number is a reading of a repository on a day — 570
...
func TestTheRepositoryWideWalksInThisPackageAreTheOnesDecidedOn(t *testing.T) {
	...
	if parses > repositoryParseBudget {
		t.Errorf("%d of this package's %d repository walks parse every Go "+
			...
			"per arm — 570 tracked Go files where that record was taken — "+
...
// stop; these four hand every Go file in the tree — 570 tracked Go files
